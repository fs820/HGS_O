...
#define INTERACT_TEX_KEY "data\\texture\\sato\\keyboard_f_outline.png"          //キーボードテクスチャ
#define INTERACT_TEX_JOY "data\\texture\\sato\\xbox_button_color_x_outline.png" //コントローラーテクスチャ
#define INTERACT_WIDTH (20.0f)                                                  //幅
#define INTERACT_HEIGHT (20.0f)                                                 //高さ
